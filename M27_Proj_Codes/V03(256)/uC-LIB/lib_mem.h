...
struct  mem_pool {
    ...
    CPU_SIZE_T      SegSizeTot;                                 /* Tot(合计) size of mem seg (in octets).                     */
...
#error  "CPU_CFG_ENDIAN_TYPE  illegally #defined in 'cpu.h'      "  //CPU_CFG_ENDIAN_TYPE定义的类型
#error  "                     [See 'cpu.h  CONFIGURATION ERRORS']"
...
#error  "                             [MUST be  > 0]                    "
   ...
   "LIB_MEM_CFG_HEAP_BASE_ADDR   illegally #define'd in 'app_cfg.h'"
#error  "                             [MUST be  > 0x0]                  "
#endif
#endif
